#ifndef __MCheckBoxRenderer
#define __MCheckBoxRenderer

#include "../IWndRenderer.h"

class MCheckBoxRenderer :
	public MObject,
	public IWndRenderer,
...
public:
	...
	/** constructor */
	MCheckBoxRenderer( String text, MColor textColor, MColor textColorDisabled  );

	/** destructor */
	virtual ~MCheckBoxRenderer();
